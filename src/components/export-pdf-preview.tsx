...
export function ExportPdfPreview({ open, onOpenChange }: ExportPdfPreviewProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[98vw] max-h-[98vh] w-[1400px] h-[98vh] overflow-y-auto">
        <DialogHeader>
        ...
        {/* PDF Preview Content */}
        <div className="bg-white dark:bg-card rounded-lg border-2 border-border shadow-lg p-12 min-w-[1200px]">
          {/* Header */}
                ...
                <table className="w-full border-collapse min-w-full">
                  <thead>
                    <tr className="border-b border-gray-300 dark:border-gray-700">
                      <th className="text-left py-2 px-4 text-sm font-semibold text-gray-900 dark:text-gray-100 min-w-[200px]">
                        Role
                      </th>
                      <th className="text-left py-2 px-4 text-sm font-semibold text-gray-900 dark:text-gray-100 min-w-[150px]">
                        Location
                      </th>
                      <th className="text-right py-2 px-4 text-sm font-semibold text-gray-900 dark:text-gray-100 min-w-[100px]">
                        Headcount
                      </th>
                      <th className="text-right py-2 px-4 text-sm font-semibold text-gray-900 dark:text-gray-100 min-w-[150px]">
                        Base Salary
                      </th>
                      <th className="text-right py-2 px-4 text-sm font-semibold text-gray-900 dark:text-gray-100 min-w-[150px]">
                        Monthly Cost
                    ...
                    {state.roles.map((role) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-2 px-4 text-sm text-right text-gray-900 dark:text-gray-100 whitespace-nowrap">
                            {role.headcount}
                          </td>
                          <td className="py-2 px-4 text-sm text-right text-gray-900 dark:text-gray-100 whitespace-nowrap">
